---
title: "Diversidad Genetica mediante el uso de marcadores mitocondriales de una Variedad Dorada de Trucha (Oncorhynchus mykiss) cultivada en el lago Titicaca."
...
## Características morfológicas de la trucha arcoíris.
...
```{r fig.cap="Trucha dorada su cuerpo está dividido en cabeza, cuerpo y cola, presenta  el cuerpo moteado de color gris y una línea lateral con 7 aletas además de la cola. Fuente propia"}

knitr::include_graphics("img/trucha.jpg")
